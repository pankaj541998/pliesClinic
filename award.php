    ...
    <section class="award-area">
        <article>
            <section class="card">
                ...
                <div class="visual">
                <img src="./assets/images/awards/awad1.jpeg" alt="" />
                </div>
            </section> 
            ...
            <section class="card">
                ...
                <div class="visual">
                <img src="./assets/images/awards/awa.jpeg" alt="" />
                </div>
            </section> 
        </article>
    </section>
    ...
    <section>
        <div class="gallery">
            <div class="gallery-item" onclick="openModal(0)">
                <img src="./assets/images/awards/2-1.jpg" alt="Venice Italie">
            </div>
            <div class="gallery-item" onclick="openModal(1)">
                <img src="./assets/images/awards/4-1.jpg" alt="Venice Italie">
            </div>
            <div class="gallery-item" onclick="openModal(2)">
                <img src="./assets/images/awards/6-1.jpg" alt="France">
            </div>
            <div class="gallery-item" onclick="openModal(3)">
                <img src="./assets/images/awards/3-1.jpg" alt="Street View">
            </div>
            <div class="gallery-item" onclick="openModal(4)">
                <img src="./assets/images/awards/5-1.jpg" alt="Provence">
            </div>
            <div class="gallery-item" onclick="openModal(5)">
                <img src="./assets/images/awards/1-2.jpg" alt="Harbor by night ">
            </div>
        </div>
    </section>
