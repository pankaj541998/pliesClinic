...
<html lang="en">
    ...
    <body>
        <div class="main_area">
            ...
            <section class="piles light-greenbg">
                <div class="container">
                    <div class="sectiondesc">
                        <h2 class="sectionttl">What is Piles?</h2>
                        <p class="smalldesc">Hemorrhoids, generally referred to as "Piles," are the lumps or swollen veins in the anus and lower rectum. They are a lot of times caused due to straining in the course of bowel movements, obesity, or pregnancy. And the truth is that today nearly three out of four adults will have piles erratically off and on. Most commonly in India, almost every other adult is detected with piles because of poor or irregular eating habits, poor hygiene, and lack of exercise.</p>
                        ...
                        <div class="text-center">
                            <a href="javascript:void(0)" class="readmorebut">Read More</a>
                        </div>
                        <h2 class="service-listttl">Symptoms of Piles:</h2>
            ...
            <!-- when to see section start -->
            <section class="when-to-see-doctor">
                <div class="container">
                    ...
                    <div class="causesreadinfo">
                        <div class="sec-read-more sec-read-more-causes">
                            ...
                            <div class="why-choose-cta text-center">
                                <!-- <div class="showSingle submit-button" target="1">BOOK APPOINTMENT</div> --></div>
                        </div>
                        <div class="readmorebtn_blk text-center">
                            <a href="javascript:void(0)" class="readmorebut readmorebutcause readless">Read More</a>
                        </div>
                    </div>
                </div>
            </section>
            <!-- when to see section end -->
            ...
            <section class="servicesec2wrap hernia-whatinfo-sec">
                <div class="container flex-between">
                        ...
                        <ul class="service-list starlist hod-list-white">
                            ...
                            <ul class="service-list starlist hod-list-white">
                                ...
                                <li>
                                    ...
                                    We utilize state-of-the-art technology and innovative treatment modalities to provide the most advanced care for our patients. Our facility is equipped with cutting-edge equipment for piles laser treatment in Mumbai, ensuring optimal outcomes and minimal discomfort for our patients.
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    We prioritize the comfort and well-being of our patients above all else. Our team is committed to providing compassionate and patient-centric care, addressing concerns, and ensuring that each individual feels supported and empowered throughout their treatment process.
                                </li>
                                <li>
                    ...
                    <div class="servicesec2 sectiondesc">
                        <h2 class="sectionttl txt-white">Piles Laser Treatment Cost In Mumbai</h2>
                        <p class="smalldesc txt-white">The cost of piles laser treatment in Mumbai can vary depending on various factors such as the severity of the condition, the specific treatment plan recommended by the doctor, the hospital or clinic where the procedure is performed, and any additional services or facilities included in the treatment package.</p>
                        <p class="smalldesc txt-white">Typically, individuals considering laser treatment for piles in Mumbai should consult with a piles specialist to obtain an accurate estimate of the costs involved. Factors such as pre-operative evaluations, the procedure itself, post-operative care, and follow-up appointments may all contribute to the overall cost of piles laser treatment in Mumbai.</p>
                        <p class="smalldesc txt-white">It's essential to inquire about potential insurance coverage or financing options that may help alleviate the financial burden associated with piles laser treatment cost in Mumbai. Additionally, understanding the benefits and potential savings compared to traditional surgical methods can help individuals make informed decisions about their treatment options.</p>
                        <p class="smalldesc txt-white">Overall, while the cost of laser treatment for piles in Mumbai may vary, it is essential to prioritize both the effectiveness of the treatment and the overall well-being of the patient when considering the financial aspects of care.</p>
                    </div>
                </div>
            </section>
            <!-- why choose us section end -->
            <!-- benifits of leaser start  -->
                ...
                <div class="container">
                    ...
                    <div class="advamtageswrap service-details dflex-space-btw text-center">
                        <div class="advantageslist bluebg rightcheckmark advantageslistpile">
                            <div class="advlistttl">Advance Laser Surgery</div>
                            <ul>
                                <li>
                        ...
                        <div class="advantageslist bluebg wrongcheckmark advantageslistpile">
                            <div class="advlistttl">Conventional Surgery</div>
                            <ul>
                                <li>
                        ...
                        <div class="advantageslist bluebg rightcheckmark advantageslistpile">
                            <div class="advlistttl">Minimal Invasive Procedure</div>
                            <ul>
                                <li>
                                    <i class="fa-solid fa-check"></i>
                                    No cuts
                                ...
                                <li>
                                    <i class="fa-solid fa-check"></i>
                                    No dressing or major post operative care required
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <!-- benifits of leaser end  -->
            <!-- best doctor section start -->
            <section class="serviceinfoblk common-padding light-greenebg">
                <div class="container">
                    <div class="sectiondesc text-center">
                        <h2 class="sectionttl">Best Doctor for Piles Treatment</h2>
                    </div>
                    <p class="smalldesc txt-black">For individuals seeking the best doctor for piles treatment, it's essential to consider factors such as expertise, experience, and patient satisfaction. A skilled and experienced piles specialist can provide personalized care and effective treatment options tailored to individual needs.</p>
                    <br>
                    <p class="smalldesc txt-black">When researching piles doctors in Mumbai, it's advisable to look for professionals who have a wealth of experience in proctology and a track record of successful outcomes. Additionally, consider factors such as the doctor's approach to patient care, the availability of advanced treatment techniques, and the overall reputation of the medical facility.</p>
                    <br>
                    <p class="smalldesc txt-black">By consulting with a reputable piles specialist in Mumbai, individuals can benefit from personalized evaluations, comprehensive treatment plans, and ongoing support throughout their journey to recovery. Whether seeking relief from piles, fissures, or fistulas, selecting the right doctor is crucial for achieving optimal outcomes and improving quality of life.</p>
                    <br>
                    <p class="smalldesc txt-black">Ultimately, individuals should choose a piles doctor in Mumbai who inspires confidence, demonstrates compassion, and prioritizes the well-being of their patients above all else. By investing time and effort in finding the right doctor, individuals can significantly enhance their chances of successful treatment and long-term relief from proctology conditions.</p>
                </div>
            </section>
            ...
            <!-- why choose doctors house section end  -->
            <!-- where we care for you start -->
            <section class="serviceinfoblk common-padding light-purplebg houseofdoctor">
                <div class="container">
                    ...
                    <div class="service-details dflex-space-btw text-center carecirclewrap1">
                        ...
                        <div class="care-info-circle care-darkbg">Covid Safe Environment</div>
                        <div class="care-info-circle">Post Recovery Care</div>
                        <div class="care-info-circle care-darkbg">Care Mate - Assistance Coordinator</div>
                        <div class="care-info-circle care-darkbg">No Cash Deposit</div>
                        <div class="care-info-circle">Documentation Free Journey</div>
                        <div class="care-info-circle care-darkbg">Surgery Financing Available</div>
                        <div class="care-info-circle">Surgery Cost Estimate</div>
                        <div class="care-info-circle care-darkbg">Daycare surgery</div>
                    </div>
                </div>
            </section>
            <!-- where we care for you end -->
            <!-- faq section start -->
            <section class="faq-section">
                <center class="sec-title centered">
                    <h2 class="sectionttl">HEMORRHOIDS (PILES) FAQS</h2>
                </center>
               <div class="container">
                 <div class="faq-accordian-area">
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="flush-headingOne">
                                <button class="accordion-button collapsed"type="button"data-bs-toggle="collapse"data-bs-target="#flush-collapseOne"aria-expanded="false"aria-controls="flush-collapseOne">
                                What is Laser Piles Surgery/Treatment?
                                </button>
                            </h2>
                            <div id="flush-collapseOne"class="accordion-collapse collapse"aria-labelledby="flush-headingOne"data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    <p class="smalldesc">Laser surgery is less invasive as no tissues need to be cut. The affected area is simply treated with laser energy in an accurate manner and the condition is healed within a few minutes. As the post-operative pain is significantly lighter in this procedure compared to surgical, the Piles laser surgery recovery time expeditiously swifts allowing the patient to resume the normal life. That is a major reason why compared to conventional open surgical hemorrhoidectomy, people prefer laser haemorrhoidoplasty.</p>
                                    <p class="smalldesc">Today every Surgeon suggest laser surgery for piles to their patients. With the help of a laser, the surgeon pinpoints the exact tissue that needs to be treated leaving the rest undisturbed. Moreover, the procedure is non-intrusive and doesn’t require any medication, since there is no bleeding involved and it is easier to recover quickly.</p>
                                    <p class="smalldesc">Today every Surgeon suggest laser surgery for piles to their patients. With the help of a laser, the surgeon pinpoints the exact tissue that needs to be treated leaving the rest undisturbed. Moreover, the procedure is non-intrusive and doesn’t require any medication, since there is no bleeding involved and it is easier to recover quickly.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="flush-headingTwo">
                                ...
                                Difference between Normal Piles Surgery and Laser Piles Surgery.
                                </button>
                            </h2>
                            <div id="flush-collapseTwo"class="accordion-collapse collapse"aria-labelledby="flush-headingTwo"data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body"><p class="smalldesc">These days everyone knows what is piles and the root behind their causes. But many a time they overestimate piles. At the stage where they can be cured by medicines, people end up opting for surgery. However, we need to understand that piles treatment is based on the stage of your piles and the level of its presence will decide whether one will undergo piles surgery or not.

</p><p class="smalldesc">With the advancement in technology, ‘Laser Technique’ came into existence with a boost and escalated the general method of surgery followed for yesteryears. Not a lot of patient requires piles surgery until they delay in negotiating the stages with the doctor. At first, the normal piles surgery happens, whereas the doctor usually recommends a laser procedure for shrinking or removing haemorrhoid.

</p><p class="smalldesc">And hence gradually with time, laser hemorrhoid surgery not only became rapidly a popular choice among healthcare professionals but also gained the trust of thousands of people who have questioned the laser treatment for piles.</p>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseThree"class="accordion-collapse collapse"aria-labelledby="flush-headingThree"data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    <p class="smalldesc">If you eat a healthy diet and lead a healthy lifestyle, it can help prevent constipation, which will prevent piles. Listed below are a few requirements that you need to meet;</p>
                                    <ul class="service-list blueiconlist">
                                        <li>Eat fiber-rich foods which include salad, chia seeds, fruits, and vegetables</li>
                                        <li>Increase fluids and regulate the consumption of caffeine, such as tea or coffee</li>
                                        <li>Avoid alcohol consumption </li>
                                        <li>Avoid the habit of reading newspapers in the washroom </li>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseFour"class="accordion-collapse collapse"aria-labelledby="flush-headingFour"data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    <p class="smalldesc">Strangulation - Arteries supplying fresh blood to the haemorrhoids can become blocked from reaching the haemorrhoids. Thus one can witness unbearably intense pain.</p>
                                    <p class="smalldesc">Anaemia - Excessive bleeding from haemorrhoids can deprive your red blood cells of oxygen. Later, fatigue, headaches, shortness of breath, and dizziness can be felt as there will be lesser oxygen supplication.</p>
                                    <p class="smalldesc">Thrombosis - When a blood clot forms inside a hemorrhoidal vein, it obstructs blood flow and causes pain in the anal tissues. Thrombosed hemorrhoids are not harmful, although they can be extremely painful and cause rectal bleeding if they become ulcerated.</p>
                                    <p class="smalldesc">Gangrene - When the blood supply to an internal hemorrhoid is cut off, the hemorrhoid strangulates, producing excruciating discomfort and eventually gangrene.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseFive"class="accordion-collapse collapse"aria-labelledby="flush-headingFive"data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    <p class="smalldesc">Due to advances in surgery recovery is faster. One can start doing regular activities from very next day.</p>
                                </div>
                            </div>
                        </div>
                    </div>
